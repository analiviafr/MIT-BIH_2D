...
def vgg16_model (input_shape, n_classes):
  model = Sequential()
  model.add(Conv1D(64, input_shape=input_shape,kernel_size=6,padding="same", activation="relu"))
  ...
  model.add(Conv1D(512, kernel_size=6, padding="valid", activation="relu"))
  model.add(Conv1D(512, kernel_size=6, padding="same", activation="relu"))
  model.add(Conv1D(512, kernel_size=6, padding="same", activation="relu"))
  model.add(MaxPool1D(pool_size=2))
  model.add(Flatten())
